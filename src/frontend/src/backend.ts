...
export class Backend implements backendInterface {
    ...
    async addChatMessage(arg0: Array<Message>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addJournalEntry(arg0: JournalEntryData): Promise<JournalEntry> {
        if (this.processError) {
            try {
    ...
    async getChatMessagesForCaller(): Promise<Array<MessageGroup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getChatMessagesForCaller();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getJournalEntriesForCaller(): Promise<Array<JournalEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getJournalEntriesForCaller();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMoodSummary(): Promise<Array<MoodSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMoodSummary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
